...
[![cloudflare-argo-tunnel-release](https://img.shields.io/github/v/release/racksync/hass-addons-zigbee2ethernet)](https://github.com/racksync/hass-addons-zigbee2ethernet/releases) [![last commit](https://img.shields.io/github/last-commit/racksync/hass-addons-zigbee2ethernet)](https://github.com/racksync/hass-addons-zigbee2ethernet/commit/)
...
ติดตั้ง addon ด้วยการ add repository : https://github.com/racksync/hass-addons-zigbee2ethernet เข้าไปยัง addon list ตามปกติ
